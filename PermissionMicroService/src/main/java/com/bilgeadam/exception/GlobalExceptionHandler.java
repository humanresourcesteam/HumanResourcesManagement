...
import static com.bilgeadam.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.bilgeadam.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(PermissionException exception){
